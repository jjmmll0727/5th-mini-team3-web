...
import RankGraphic from '../icons/img_rankGraphic_mySite_ranking_s.svg';
...
const RankCard = ({rank, title, imgsrc, href}) => {
    return(
        <Container>
            <GraphicWrapper><RankGraphic /></GraphicWrapper>          
            <AllWrapper>
                <Logo><img src={imgsrc} />
                <FlexWrapper>
                    <TextWrapper>
                        ...
                        <Shape><a href={href} target='_blank'>방문하기</a></Shape>  
                    </TextWrapper>
                </FlexWrapper>               
                </Logo>
            </AllWrapper>
